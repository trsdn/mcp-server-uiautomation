...
4. **Create a publisher account** (if you don't have one)
   ...
   - Click "Create publisher"
    - Publisher ID: Should match `package.json` publisher field (currently `trsdn`)
...
6. **Creates GitHub Release** with all shipped components (MCP Server, CLI, VS Code extension, VSIX artifact)
