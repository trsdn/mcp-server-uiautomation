...
public sealed class UiAutomationService
{
    ...
    public UiAutomationTextInfo? ReadText(UiAutomationLocateRequest locator, string? findText = null, bool matchCase = false, bool searchBackward = false) =>
        UiAutomationBootstrap.ReadText(locator, findText, matchCase, searchBackward);
